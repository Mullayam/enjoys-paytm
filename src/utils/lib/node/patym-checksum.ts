...
function genchecksum(params: any, key: string, cb: any) {
  var data = paramsToString(params);

  crypt.gen_salt(4, function (err: any, salt: string) {
    var sha256 = crypto
      .createHash("sha256")
      .update(data + salt)
      .digest("hex");
...
function genchecksumbystring(params: any, key: string, cb: any) {
  crypt.gen_salt(4, function (err: any, salt: string) {
    var sha256 = crypto
      .createHash("sha256")
      .update(params + "|" + salt)
...
function verifychecksum(params: any, key: string, checksumhash: string) {
...
function verifychecksumbystring(
  params: any,
  key: string,
  checksumhash: string
) {
...
function genchecksumforrefund(params: any, key: string, cb: any) {
