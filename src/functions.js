...
var Constants = /** @class */ (function () {
    ...
    Constants.prototype.CreateURL = function (env, queryParams) {
        if (env === void 0) { env = "TEST"; }
        if (env === "TEST") {
            return "https://securegw-stage.paytm.in/theia/processTransaction?".concat(queryParams);
        }
        else {
            return "https://securegw.paytm.in/theia/processTransaction?".concat(queryParams);
        }
    };
    Constants.prototype.CreateChecksum = function (params, key) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    Constants.prototype.CreateSSOToken = function () { };
